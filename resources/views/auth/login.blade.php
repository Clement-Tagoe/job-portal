<x-app-layout>
  <div class="w-full mt-24 mb-10">
        <div class="w-11/12 md:w-10/12 lg:w-8/12 mx-auto flex flex-col items-center justify-center md:flex-row rounded-lg border border-gray-300">
            <div class="w-full md:w-1/2">
                <div class="w-11/12 md:w-10/12 mx-auto 2xl:-mt-32">
