        ...
        <div class="w-11/12 mx-auto flex space-x-6 pt-10">
            <div class="w-full lg:w-8/12">
                <div class="bg-white mb-6">
                    ...
                    <div class="p-5">
                        <form action="/job-seeker/experience" method="POST">
                            @csrf
                            <div class="flex space-x-3 text-gray-600 mb-3">
                                <input type="checkbox" name="no_work_experience" @checked(old('no_work_experience'))>
                            ...
                            <div class="w-full flex flex-col space-y-3 md:space-y-0 md:flex-row md:space-x-6 mb-3">
                                <div class="w-full md:w-1/2">
                                    ...
                                    <select name="job_level" id="job_level" class="h-10 py-1 px-2 rounded-md border border-gray-300 hover:border-gray-400 outline-none text-gray-500 placeholder-gray-400 w-full block mt-1">
                                        ...
                                        <option value="Graduate-Trainee" {{ old('job_level') == 'Graduate-Trainee' ? 'selected' : '' }}>Graduate-Trainee</option>
                                        <option value="Volunteer/Internship" {{ old('job_level') == 'Volunteer/Internship' ? 'selected' : '' }}>Volunteer/Internship</option>
                                        ...
                                        <option value="Management-Level" {{ old('job_level') == 'Management-Level' ? 'selected' : '' }}>Management-Level</option>
                                        <option value="Executive-Level" {{ old('job_level') == 'Executive-Level' ? 'selected' : '' }}>Executive-Level</option>
                                        <option value="No-Experience" {{ old('job_level') == 'No-Experience' ? 'selected' : '' }}>No-Experience</option>
                                        <option value="Others" {{ old('job_level') == 'Others' ? 'selected' : '' }}>Others</option> 
                                    </select>
                                    @error('job_level')
                                        <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                                    @enderror
                            ...
                            <div class="w-full flex flex-col space-y-3 md:space-y-0 md:flex-row md:space-x-6 mb-3">
                                ...
                                <div class="w-full md:w-1/2">
                                    ...
                                    <select name="work_type" id="work_type" class="h-10 py-1 px-2 rounded-md border border-gray-300 hover:border-gray-400 outline-none text-gray-500 placeholder-gray-400 w-full block mt-1">
                                        ...
                                        <option value="Internship/Graduate" {{ old('work_type') == "Internship/Graduate" ? 'selected' : '' }}>Internship/Graduate</option>
                                    </select>
                                    @error('work_type')
                                        <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                                    @enderror
                                    ...
                                    <div class="flex flex-col md:flex-row md:space-x-2">
                                        ...
                                        <div class="w-full md:w-1/2">
                                            <select name="start_year" class="h-10 py-1 px-2 rounded-md border border-gray-300 hover:border-gray-400 outline-none text-gray-500 placeholder-gray-400 w-full block mt-1">
                                                ...
                                                @endphp
                                                @for ($x = 0; $x <=50; $x++)
                                                    <option value="{{$year - $x}}" {{old('start_year') == $year - $x ? 'selected' : ''}}>{{$year - $x}}</option>
                                                @endfor  
                                            </select>
                                            @error('start_year')
                                                <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                                    ...
                                    <div class="flex flex-col md:flex-row md:space-x-2">
                                        <div class="w-full md:w-1/2">
                                            <select name="end_month" class="h-10 py-1 px-2 rounded-md border border-gray-300 hover:border-gray-400 outline-none text-gray-500 placeholder-gray-400 w-full block mt-1">
                                                <option value="">Month</option>
                                                <option value="January" {{old('end_month') == 'January' ? 'selected' : ''}}>January</option>
                                                <option value="February" {{old('end_month') == 'February' ? 'selected' : ''}}>February</option>
                                                <option value="March" {{old('end_month') == 'March' ? 'selected' : ''}}>March</option>
                                                <option value="April" {{old('end_month') == 'April' ? 'selected' : ''}}>April</option>
                                                <option value="May" {{old('end_month') == 'May' ? 'selected' : ''}}>May</option>
                                                <option value="June" {{old('end_month') == 'June' ? 'selected' : ''}}>June</option>
                                                <option value="July" {{old('end_month') == 'July' ? 'selected' : ''}}>July</option>
                                                <option value="August" {{old('end_month') == 'August' ? 'selected' : ''}}>August</option>
                                                <option value="September" {{old('end_month') == 'September' ? 'selected' : ''}}>September</option>
                                                <option value="October" {{old('end_month') == 'October' ? 'selected' : ''}}>October</option>
                                                <option value="November" {{old('end_month') == 'November' ? 'selected' : ''}}>November</option>
                                                <option value="December" {{old('end_month') == 'December' ? 'selected' : ''}}>December</option>
                                            </select>
                                            @error('end_month')
                                                <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                                            @enderror    
                            ...
                            <div class="flex space-x-3 text-gray-600 mb-3">
                                <input type="checkbox" name="currently_work_here" @checked(old('currently_work_here'))>
                            ...
                            <div class="mb-6">
                                ...
                                @error('job_responsibilities')
                                    <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                                @enderror
                                <textarea name="job_responsibilities" id="job_responsibilities" cols="30" rows="5" class="w-full rounded-md">{{old('job_responsibilities')}}</textarea>
