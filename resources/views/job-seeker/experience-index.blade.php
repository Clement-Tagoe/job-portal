        ...
        <div class="w-11/12 mx-auto flex space-x-6 pt-10 pb-6">
            <div class="w-full lg:w-8/12">
                <div class="bg-white">
                    ...
                    <p class="text-gray-600 pl-3 py-5">Add your Work Experience. Such as an internship, part-time work or long term specialised experience.</p>
                    <hr>
                    @foreach ($workExperiences as $workExperience)
                        <div class="mt-2 pl-5">
                            <h2 class="text-gray-600 font-medium">{{$workExperience->job_title .' at ' . $workExperience->employer }}</h2>
                            <div class="flex flex-col md:flex-row md:items-center md:space-x-3 text-gray-500 text-sm">
                            ...
                            <p class="text-gray-500 text-sm">Entry level</p>
                            <div class="flex flex-col md:flex-row md:items-center md:space-x-3 text-gray-500 text-sm">
                            ...
                            <div class="custom-ul mb-2">
                                @php
                                    echo $workExperience->job_responsibilities;
                                @endphp
                            </div>
                        </div>
                        <hr class="">
                        <div x-cloak x-data="{isOpen: false}">
                            <div class="flex items-center justify-between px-3 py-2 border-b border-gray-300">
                                ...
                                <a href="{{route('work-experience.edit', $workExperience)}}" class="flex space-x-2 px-3 bg-orange-600 hover:bg-orange-500 text-white py-2 rounded-2xl">
                                    <span>Edit</span> 
                ...
                <div class="flex flex-col space-y-2 md:space-y-0 md:flex-row justify-between p-5 bg-white">
                    ...
                    <a href="/job-seeker/experience/create" class="text-white bg-blue-700 px-12 py-2 rounded-md uppercase">Add</a>
                </div>
